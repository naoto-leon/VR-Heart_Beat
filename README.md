...
##### [実演動画](https://www.youtube.com/watch?v=tZrFdnDNbas&feature=youtu.be)
...
***
  ...
  (batchesに関してはdebuglogを無くすこと、gpuインスタンスの利用でクリア。個人的にはset-passが100以下であればcpuが安定しているイメージなのでそこまで気にしてない。)  
